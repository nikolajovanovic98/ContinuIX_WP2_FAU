...
Runs the "steady state" simulation for Aletsch given SMB forcing (here, $\mathrm{ELA} = 2800\,\mathrm{m}$). $110$ years needed for the glacier to equilibrate $(\mathrm{dh}/\mathrm{dt} \approx 0\,\mathrm{m}\,\mathrm{y}^{-1})$.  
